                ...
                <Card className="d-flex p-4 text-white border rounded-3 w-50" style={{ background: "#111" }}>
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <div className="d-flex justify-content-between mb-3">
                            <div><span>Need an Account? </span>
                                <a href="/signup" className="text-white fw-bold text-decoration-none"> Sign up</a></div>

                            <a href="#" className="text-white">Forgot password?</a>
                        </div>


                        <Button variant="primary" className="w-100" type='submit'>Continue</Button>
                    </Form>
                </Card>
            </Container>
        </div>
